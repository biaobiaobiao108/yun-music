...
export const playerApi = {
  ...
  cacheMove: (items: Array<{ filename: string; folder?: string; user?: string; rawUsername?: string }>, targetFolder: 'cache' | 'music' = 'music') => requestJson<{ success?: boolean; successCount?: number; failCount?: number; moved?: unknown[] }>('/api/music/cache/move', { method: 'POST', body: JSON.stringify({ items, targetFolder }) }),
