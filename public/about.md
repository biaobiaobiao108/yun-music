...
项目提供同源的音乐搜索、播放、歌单、收藏和缓存能力，并提供用户、数据、快照、配置、日志、服务状态及管理员自定义音源管理。
...
**[Web 播放器](/music)**：内置功能强大的 Web 端音乐播放器，支持多源搜索、歌单、收藏、歌词和缓存；播放器只使用管理员配置并分配的音源。

### 🔌 自定义音源

管理员可在后台“自定义源”中维护公共音源和账户专属音源。播放器端只负责读取和使用已启用的音源，不提供脚本上传、导入、删除或排序操作。
...
<div align="center" style="margin-top: 30px;">
  <a href="https://github.com/biaobiaobiao108/yun-music" target="_blank" style="display: inline-block; padding: 12px 24px; background-color: #10b981; color: white; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">
